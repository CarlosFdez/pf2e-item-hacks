...
import { AbilityBasedStatistic, AbilityString, ActorSystemData, ActorSystemSource, BaseActorAttributes, BaseActorDataPF2e, BaseActorSourcePF2e, BaseTraitsData, HitPointsData, InitiativeData, Rollable, StrikeData } from "@actor/data/base";
...
declare type CreatureSkills = Record<SkillAbbreviation, Statistic> & Partial<Record<string, Statistic>>;
