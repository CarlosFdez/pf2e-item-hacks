import { Abilities, BaseCreatureData, BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureHitPoints, CreatureInitiative, CreatureSystemData, HeldShieldData, SaveData, SkillData } from "@actor/creature/data";
...
export { NPCArmorClass, NPCAttributes, NPCData, NPCHitPoints, NPCPerception, NPCSaveData, NPCSkillData, NPCSource, NPCStrike, NPCSystemData, };
