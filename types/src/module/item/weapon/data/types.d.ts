...
declare type WeaponRangeIncrement = typeof WEAPON_RANGES[number];
...
export { ComboWeaponMeleeUsage, OtherWeaponTag, WeaponData, WeaponMaterialData, WeaponPropertyRuneSlot, WeaponRangeIncrement, WeaponSource, WeaponSystemData, WeaponSystemSource, };
